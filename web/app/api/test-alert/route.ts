...
async function run(opts: Opts) {
  ...
  const rawSamples = [
    ...
    {
      kind: "work_trigger_due_soon",
      title: "Work item due in 1 day",
      detail: "Acme Foods Ltd (sample) — Send the follow-up deck",
      due_on: today,
      summary: "Sample work-item heads-up. Fires one day before the trigger date.",
      factory_id: acme,
      work_item_id: "00000000-0000-0000-0000-0000000000d1",
    },
    {
      kind: "work_trigger_overdue_3d",
      title: "Work item overdue by 3+ days",
      detail: "Acme Foods Ltd (sample) — Send the follow-up deck",
      due_on: today,
      summary: "Sample overdue escalation. Fires once the card is 3+ days past its trigger.",
      factory_id: acme,
      work_item_id: "00000000-0000-0000-0000-0000000000d2",
    },
    {
