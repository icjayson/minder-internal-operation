              ...
              >
                    ...
                    className={`grid h-6 w-6 place-items-center rounded-full border text-[10px] font-semibold transition-all duration-200 ${
                      completed
                        ...
                        : active
                          ...
                          : "border-line-strong bg-surface text-muted-foreground group-hover:border-[var(--journey-accent)] group-hover:text-[var(--journey-accent)]"
                    }`}
                  >
                ...
                <span
                  className={`mt-1 max-w-full text-[10.5px] leading-tight transition-colors ${
                    active ? "font-semibold text-ink" : completed ? "text-ink-soft" : "text-muted-foreground group-hover:text-ink-soft"
                  }`}
                  title={step.label}
                >
